...
(function (factory) {
    ...
    $.jstree.defaults.checkbox = {
        ...
        cascade: '',
        /**
         * This setting controls if checkbox are bound to the common tree selection or to an internal array maintained by the checkbox plugin. Defaults to `true`, only set to `false` if you know exactly what you are doing.
